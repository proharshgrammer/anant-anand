...
- [x] 04-01: Create Tour Detail page layout, day accordion, pricing matrix, and dynamic Leaflet.js Route Map.
- [x] 04-02: Integrate the Lead Capture form to write enquiries to Supabase, validating inputs (Indian phone formatting, group sizes).
